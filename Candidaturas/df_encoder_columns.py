...
def ReturnEncoderColumns():
    ...
    df_encoder_columns["empresas_onde_trabalhou"] = labelEnconder.fit_transform(df_encoder_columns["empresas_onde_trabalhou"])
   
    df_encoder_columns["cargo_na_empresa"] = labelEnconder.fit_transform(df_encoder_columns["cargo_na_empresa"])
