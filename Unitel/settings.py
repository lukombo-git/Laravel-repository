"""
Django settings for Unitel project.
...
SECRET_KEY = 's7c2lp1%bubbxi=f47ftte(guqnuw!5)cmqg*!%ffn43$!l5k='
...
WSGI_APPLICATION = 'Unitel.wsgi.application'
...
LOGIN_REDIRECT_URL='/Candidaturas/login'